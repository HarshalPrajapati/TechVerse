...
if($id)
{
$sql_student="SELECT * FROM Students WHERE StudentID=$id";
$student_details=$conn->query($sql_student);
if($student_details->num_rows===1)
{
...
$sql_enroll="SELECT a.StudentID,a.Department,a.YearOfStudy,e.EnrollmentDate,e.CourseID,c.CourseName,c.Department FROM AcademicDetails a,Enrollments e,Courses c WHERE a.StudentID=e.StudentID AND e.CourseID=c.CourseID AND a.StudentID=$id";
    ...
    <div class="row">
      <div class="col-md-8">
        <ul class="list-inline custom-breadcrumb">
          <li class="list-inline-item"><a class="h2 text-primary font-secondary" href="student.php">Our Students</a></li>
          <?php if ($student): ?>
          <li class="list-inline-item text-white h3 font-secondary nasted"><?php echo $student['FirstName'] . ' ' . $student['LastName'];?></li>
          <?php else: ?>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-5 mb-5">
        <img class="img-fluid w-100" src="../educenter-master<?php echo $student['Profile'] ? $student['Profile'] : 'images/teachers/default.jpg'; ?>" alt="teacher">
      </div>
      <div class="col-md-6 mb-5">
        <h3><?php echo $student['FirstName'] . ' ' . $student['LastName'];?></h3>
        <h6 class="text-color"><?php echo $student['DateOfRegistration'];?></h6>
        <p class="mb-5">Behind every successful student is a dedicated teacher. Our student is the heart of academic excellence.</p>
        <div class="row">
          <div class="col-md-6 mb-5 mb-md-0">
            <h4 class="mb-4">CONTACT INFO:</h4>
            <ul class="list-unstyled">
              <li class="mb-3"><a class="text-color" href="mailto:<?php echo $student['Email'];?>"><i class="ti-email mr-2"></i><?php echo $student['Email'];?></a></li>
              <li class="mb-3"><a class="text-color" href="callto:<?php echo $student['ContactNumber'];?>"><i class="ti-mobile mr-2"></i><?php echo $student['ContactNumber'];?></a></li>
              <li class="mb-3"><a class="text-color" href="#"><i class="ti-facebook mr-2"></i><?php echo $student['FirstName'] . ' ' . $student['LastName'];?></a></li>
              <li class="mb-3"><a class="text-color" href="#"><i class="ti-twitter-alt mr-2"></i><?php echo $student['FirstName'] . ' ' . $student['LastName'];?></a></li>
              <li class="mb-3"><a class="text-color" href="#"><i class="ti-skype mr-2"></i><?php echo $student['FirstName'] . ' ' . $student['LastName'];?></a></li>
              <li class="mb-3"><a class="text-color" href="#"><i class="ti-world mr-2"></i><?php echo $student['FirstName'] . ' ' . $student['LastName'];?></a></li>
              <li class="mb-3"><a class="text-color" href="#"><i class="ti-location-pin mr-2"></i><?php echo $student['Address'];?></a></li>
            </ul>
          </div>
          <div class="col-md-6">
      ...
      <div class="col-12">
        ...
        <p class="mb-5">
              ...
              our faculty members are dedicated to providing high-quality education and
              mentorship to students. They actively engage in research, contribute to
              curriculum development, and strive to create an inclusive and dynamic learning environment.
              Committed to academic excellence, each faculty member brings a unique blend of expertise,
              innovation, and passion to the classroom, inspiring students to reach their full potential
    ...
    <div class="row justify-content-center">
      ...
      <!-- course item -->
      <?php while($course=$result_enroll->fetch_assoc()):?>
      <div class="col-lg-4 col-sm-6 mb-5">
        <div class="card p-0 border-primary rounded-0 hover-shadow">
          <img class="card-img-top rounded-0" src="images/courses/course-4.jpg" alt="course thumb">
          <div class="card-body">
            <ul class="list-inline mb-2">
              <li class="list-inline-item"><i class="ti-calendar mr-1 text-color"></i><?php echo $course['EnrollmentDate'] . ' ' . $course['Department']; ?></li>
              <li class="list-inline-item"><a class="text-color" href="../educenter-master/student-single.php?id=<?php echo $student['StudentID']; ?>"><?php echo $student['FirstName'] . ' ' . $student['LastName'];?></a></li>
            </ul>
            <a href="courses.php">
              <h4 class="card-title"><?php echo $course['CourseName'];?></h4>
            </a>
            <p class="card-text mb-4"> Knowledge empowers, and every course we offer
               is designed to equip you with the tools for a brighter future.</p>

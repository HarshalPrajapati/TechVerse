...
if($id)
{
$sql_faculty="SELECT * FROM Faculty WHERE FacultyID=$id";
$faculty_details=$conn->query($sql_faculty);
if($faculty_details->num_rows===1)
{
  $faculty=$faculty_details->fetch_assoc();
}
}

$sql_courses="SELECT * FROM Courses";
$course_details=$conn->query($sql_courses);
    ...
    <div class="row">
      <div class="col-md-8">
        <ul class="list-inline custom-breadcrumb">
          ...
          <?php if ($faculty): ?>
          <li class="list-inline-item text-white h3 font-secondary nasted"><?php echo $faculty['FirstName'] . ' ' . $faculty['LastName'];?></li>
          <?php else: ?>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-5 mb-5">
        <img class="img-fluid w-100" src="../educenter-master<?php echo $faculty['Profile'] ? $faculty['Profile'] : 'images/teachers/default.jpg'; ?>" alt="teacher">
      </div>
      <div class="col-md-6 mb-5">
        <h3><?php echo $faculty['FirstName'] . ' ' . $faculty['LastName'];?></h3>
        <h6 class="text-color"><?php echo $faculty['Department'];?></h6>
        <p class="mb-5">Behind every successful student is a dedicated teacher. Our faculty is the heart of academic excellence.</p>
        <div class="row">
          <div class="col-md-6 mb-5 mb-md-0">
            <h4 class="mb-4">CONTACT INFO:</h4>
            <ul class="list-unstyled">
              <li class="mb-3"><a class="text-color" href="mailto:<?php echo $faculty['Email'];?>"><i class="ti-email mr-2"></i><?php echo $faculty['Email'];?></a></li>
              <li class="mb-3"><a class="text-color" href="callto:<?php echo $faculty['ContactNumber'];?>"><i class="ti-mobile mr-2"></i><?php echo $faculty['ContactNumber'];?></a></li>
              <li class="mb-3"><a class="text-color" href="#"><i class="ti-facebook mr-2"></i><?php echo $faculty['FirstName'] . ' ' . $faculty['LastName'];?></a></li>
              <li class="mb-3"><a class="text-color" href="#"><i class="ti-twitter-alt mr-2"></i><?php echo $faculty['FirstName'] . ' ' . $faculty['LastName'];?></a></li>
              <li class="mb-3"><a class="text-color" href="#"><i class="ti-skype mr-2"></i><?php echo $faculty['FirstName'] . ' ' . $faculty['LastName'];?></a></li>
              <li class="mb-3"><a class="text-color" href="#"><i class="ti-world mr-2"></i><?php echo $faculty['FirstName'] . ' ' . $faculty['LastName'];?></a></li>
              <li class="mb-3"><a class="text-color" href="#"><i class="ti-location-pin mr-2"></i><?php echo $faculty['Address'];?></a></li>
            </ul>
          </div>
          <div class="col-md-6">
    ...
    <div class="row justify-content-center">
      ...
      <!-- course item -->
      <?php while($course=$course_details->fetch_assoc()):?>
        ...
        <div class="card p-0 border-primary rounded-0 hover-shadow">
          ...
          <div class="card-body">
            <ul class="list-inline mb-2">
              ...
              <li class="list-inline-item"><a class="text-color" href="../educenter-master/teacher-single.php?id=<?php echo $faculty['FacultyID']; ?>"><?php echo $faculty['FirstName'] . ' ' . $faculty['LastName'];?></a></li>
            </ul>
            <a href="courses.php">
